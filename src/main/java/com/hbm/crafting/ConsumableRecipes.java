...
public class ConsumableRecipes {
	...
	public static void register() {
		...
		CraftingManager.addShapelessAuto(new ItemStack(ModItems.night_vision_mk2, 1), new Object[] { ModItems.night_vision, DictFrame.fromOne(ModItems.battery_sc, ItemBatterySC.EnumBatterySC.PU238) });
