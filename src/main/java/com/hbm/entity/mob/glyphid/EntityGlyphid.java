...
public class EntityGlyphid extends EntityMob implements IResistanceProvider {
	...
	protected void entityInit() {
		super.entityInit();
		this.dataWatcher.addObject(DW_WALL, (byte) 0);		//wall climbing
		this.dataWatcher.addObject(DW_ARMOR, (byte) 0b11111);	//armor
		this.dataWatcher.addObject(DW_SUBTYPE, (byte) 0);		//subtype (i.e. normal, infected, etc)
	}
