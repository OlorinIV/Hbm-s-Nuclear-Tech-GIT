...
public class PUREXRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		this.register(new GenericRecipe("purex.zirnoxthmeu").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.zirnoxmox").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.zirnoxheu233").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.zirnoxheu235").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.zirnoxles").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.zirnoxzfbmox").setup(80, zirnoxPower).setNameWrapper("purex.recycle").setGroup(autoZirnox, this)
		...
		this.register(new GenericRecipe("purex.platemox").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.platepu238be").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.platepu239").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.platera226be").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.platesa326").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.plateu233").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.plateu235").setup(80, platePower).setNameWrapper("purex.recycle").setGroup(autoPlate, this)
		...
		this.register(new GenericRecipe("purex.pwrmeu").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrheu233").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrheu235").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrmen").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhen237").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrmox").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrmep").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhep239").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhep241").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrmea").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhea242").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhes326").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrhes327").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrbfbam").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		this.register(new GenericRecipe("purex.pwrbfbpu241").setup(80, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
		...
		// Molten Salt
		this.register(new GenericRecipe("purex.thoriumsalt").setup(80, 10_000).setIcon(ModItems.fluid_icon, Fluids.THORIUM_SALT.getID())
		...
		this.register(new GenericRecipe("purex.watzschrab").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzhes").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzmes").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzles").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzhen").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzmep").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzlead").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzboron").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		this.register(new GenericRecipe("purex.watzdu").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		if(naquadriaNuggets.size() != 0) {
			...
			this.register(new GenericRecipe("purex.watznaqadah").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
			...
			this.register(new GenericRecipe("purex.watznaqadria").setup(40, watzPower).setNameWrapper("purex.recycle").setGroup(autoWatz, this)
		...
		//ICF
		this.register(new GenericRecipe("purex.icf").setup(240, 10_000).setNameWrapper("purex.recycle")
		...
		/// Vitrification
		this.register(new GenericRecipe("purex.vitliquid").setup(80, vitrification)
		...
		this.register(new GenericRecipe("purex.vitgaseous").setup(80, vitrification)
				.inputItems(new ComparableStack(ModBlocks.sand_lead))
		...
		// Schrabidium
		this.register(new GenericRecipe("purex.schraranium").setup(160, 1_000).setNameWrapper("purex.schrab")
		...
		this.register(new GenericRecipe("purex.schrabzirnox").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.waste_plutonium))
				...
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						...
						new ItemStack(ModItems.nuclear_waste_tiny, 4))
				.setIconToFirstIngredient());
		this.register(new GenericRecipe("purex.schrabpwr").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.pwr_fuel_depleted, 1, EnumPWRFuel.MEP))
				.inputFluids(new FluidStack(Fluids.SOLVENT, 4_000), new FluidStack(Fluids.SCHRABIDIC, 500))
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						new ItemStack(ModItems.nugget_technetium, 3),
						new ItemStack(ModItems.nuclear_waste_tiny, 4))
				.setIconToFirstIngredient());
		this.register(new GenericRecipe("purex.schrabmen").setup(160, 50_000).setNameWrapper("purex.schrab").setGroup(autoSchrab, this)
				.inputItems(new ComparableStack(ModItems.pwr_fuel_depleted, 1, EnumPWRFuel.MEN))
				.inputFluids(new FluidStack(Fluids.SOLVENT, 4_000), new FluidStack(Fluids.SCHRABIDIC, 500))
				.outputItems(new ItemStack(ModItems.powder_schrabidium, 1),
						new ItemStack(ModItems.nugget_technetium, 3),
